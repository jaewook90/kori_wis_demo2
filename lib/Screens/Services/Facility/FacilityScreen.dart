...
class _FacilityScreenState extends State<FacilityScreen> {
  ...
  final CountdownController _controller2 = CountdownController(autoStart: true);
        ...
        child: Stack(
          children: [
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage(bottomBanner))),
                  child: Stack(
                    children: [
                      Container(
                        ...
                        onTap: () {
                          ...
                          Future.delayed(const Duration(milliseconds: 100), () {
                            setState(() {
                              ...
                              _controller.restart();
                              officeNumber = 0;
                              _mainStatusProvider.targetFacilityIndex =
                                  officeNumber;
                            });
                          });
                        },
            ...
            AnimatedContainer(
              duration: const Duration(milliseconds: 500),
              curve: Curves.easeIn,
              height: officeSelected
                  ? officeSelectionTimeOut
                      ? 146 * 3
                      : 181 * 3
                  : 0,
              width: 1080,
                  ...
                  Offstage(
                    ...
                    child: Stack(
                      children: [
                        Padding(
                          padding:
                              const EdgeInsets.only(top: 54 * 3, left: 17 * 3),
                          child: Container(
                            width: 280 * 3,
                            height: 62 * 3,
                            child: Stack(
                              children: [
                                ((officeNumber != 14 && officeNumber != 15) &&
                                        officeNumber != 16)
                                    ? Padding(
                                        padding:
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              image: DecorationImage(
                                                  image: AssetImage(
                                                      'assets/images/facility/banners/${_mainStatusProvider.facilityNum![officeNumber]}.png'))),
                                        ),
                                      )
                                    : Container(),
                                Padding(
                        ...
                        Countdown(
                          ...
                          seconds: 10,
                          build: (_, double time) {
                            if (officeSelectionTimeOut == false) {
                              _controller2.restart();
                              _controller2.pause();
                            }
                            return Container();
                  ...
                  Offstage(
                    ...
                    child: Stack(
                      children: [
                        Padding(
                          padding:
                              const EdgeInsets.only(top: 50 * 3, left: 70 * 3),
                          child: Container(
                            width: 230 * 3,
                            child: const Text(
                              '"다른 장소 안내를 원하시나요?"',
