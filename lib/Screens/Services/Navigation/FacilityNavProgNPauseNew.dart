...
class _FacilityNavigationNewProgNPauseState extends State<FacilityNavigationNewProgNPause> {
  ...
  void initState() {
    ...
    navTopTextBoxTextColor = Color(0xff00d7d4);
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: [
                    ...
                    Padding(
                      padding:
                      EdgeInsets.only(top: 23 * 3, left: navTopStateBoxPaddingLeft),
                      child: Container(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsets.only(
                                  top: navTopTextBoxIconPaddingTop, left: 7.5 * 3),
                            ...
                            Padding(
                              padding:
                              EdgeInsets.only(top: 4.5 * 3, left: navTopTextBoxTextPaddingLeft),
                              child: Text(
                                navTopTextBoxText,
                                style: TextStyle(
                                    fontFamily: 'kor',
                      ...
                      TextButton(
                          onPressed: () {
                            setState(() {
                              ...
                              navTopDivider = 'assets/images/facility/facNav/line_3.svg';
                              navTopStateBoxWidth = 67*3;
                              navTopStateBoxHeight = 24*3;
                              navTopStateBoxPaddingLeft = 256*3;
                              navTopTextBoxIcon = 'assets/images/facility/facNav/navPauseIcon.svg';
                              navTopTextBoxIconSize = 14;
                              navTopTextBoxIconPaddingTop = 5*3;
                              navTopTextBoxTextPaddingLeft = 24.5*3;
                              navTopTextBoxTextColor = Color(0xffffffff);
